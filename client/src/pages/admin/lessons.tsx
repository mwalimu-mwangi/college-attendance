...
import InstantLessonForm from "@/components/admin/instant-lesson-form";
import {
  Dialog,
  DialogContent,
  DialogDescription,
      ...
      <div className="fade-in">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          ...
          <div className="md:col-span-2">
            <p className="text-sm font-medium text-neutral-500 mb-2">Quick Guide</p>
            <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded">
              <h3 className="font-medium text-blue-800">Creating Lessons</h3>
              <ul className="list-disc list-inside text-sm text-blue-700 mt-2 space-y-1">
                <li>Use <strong>Instant Lesson</strong> to create a lesson starting now</li>
                <li>Use <strong>Add Lesson</strong> to schedule regular lessons</li>
                <li>Instant lessons are useful for unplanned or special classes</li>
                <li>Students will be able to mark attendance immediately</li>
              </ul>
            </div>
          </div>
        </div>
